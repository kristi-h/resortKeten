...
export default function Contact(){
    return(
        <div className="container_info">
            <h1 className="title">Reach out to us to get any other questions answered.</h1>
            <h3>Email: info@resortken.com</h3>

            <h2>Frequently Asked Questions</h2>
            <h4>How many bedrooms are there?</h4>
            <p>There are two full bedrooms with queen sized beds.</p>
            <h4>How many bathrooms are there?</h4>
            <p>There is one full bathroom and a half size bathroom for guests.</p>
            <h4>How big is the property?</h4>
            <p></p>
